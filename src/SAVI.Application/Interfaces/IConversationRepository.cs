...
public interface IConversationRepository
{
    ...
    Task<IReadOnlyList<Conversation>> GetAllAsync(bool includeArchived = false, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<Conversation>> SearchAsync(string query, CancellationToken cancellationToken = default);
