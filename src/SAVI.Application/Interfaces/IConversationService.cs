...
public interface IConversationService
{
    ...
    Task<Message> AppendMessageAsync(string conversationId, MessageRole role, string content, MessageType type = MessageType.Text, string? sourcesJson = null, string? toolsJson = null, CancellationToken cancellationToken = default);
